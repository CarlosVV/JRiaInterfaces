Requirment to run  Golden Crown  Web Service
----------------------------------------------------------------------------------------------------------------------------------------------------
Golden Crown Url: https://dp.korona.net:2102/qpay_int_in/services/phttp
...
8)	Right click on the certificate and choose "All Tasks --> Manage Private Keys" and "IIS_USER" or other user or app pool account that the IIS 7.5
	 app pool is using (ApplicationPoolIdentity).
