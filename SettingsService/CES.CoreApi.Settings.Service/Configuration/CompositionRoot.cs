...
namespace CES.CoreApi.Settings.Service.Configuration
{
    internal class CompositionRoot
    {
        ...
        {
            container.RegisterSingle<ICountrySettingsProcessor, CountrySettingsProcessor>();
        ...
        private static void RegisterInterceptions(Container container)
        {
            ...
            container.InterceptWith<PerformanceInterceptor>(type => type == typeof(ICountryRepository));
            container.InterceptWith<PerformanceInterceptor>(type => type == typeof(ICountrySettingsProcessor));
