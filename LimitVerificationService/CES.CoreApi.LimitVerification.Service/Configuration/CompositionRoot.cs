...
using CES.CoreApi.LimitVerification.Service.Utilities;
...
namespace CES.CoreApi.LimitVerification.Service.Configuration
{
    internal class CompositionRoot
    {
        ...
        {
            container.RegisterSingle<IAgentLimitVerificationProcessor, IAgentLimitVerificationProcessor>();
        ...
        private static void RegisterInterceptions(Container container)
        {
            ...
            container.InterceptWith<PerformanceInterceptor>(type => type == typeof(IAgentLimitVerificationProcessor));
        ...
        {
            container.Register<CheckPayingAgentLimitsResponse, CheckPayingAgentLimitsResponse>();
