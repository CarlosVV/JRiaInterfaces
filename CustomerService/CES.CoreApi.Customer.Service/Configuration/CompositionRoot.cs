...
namespace CES.CoreApi.Customer.Service.Configuration
{
    internal class CompositionRoot
    {
        ...
        {
            container.RegisterSingle<ICustomerRequestProcessor, CustomerRequestProcessor>();
        ...
        private static void RegisterInterceptions(Container container)
        {
            ...
            container.InterceptWith<PerformanceInterceptor>(type => type == typeof(ICustomerRequestProcessor));
        }
