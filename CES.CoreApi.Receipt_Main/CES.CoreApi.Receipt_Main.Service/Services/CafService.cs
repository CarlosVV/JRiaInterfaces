    ...
    public class CafService
    {
        ...
        public TaxCreateCafFResponse CreateCAF(TaxCreateCafRequest request)
        {
            ...
            try
            {
                ...
                var objDbCaf = CreateCAFModel(request.FolioStartNumber,request.FolioEndNumber, request.RecAgent, request.CAFContent, objCAF);
        ...
        internal object UpdateCAF(TaxUpdateCafRequest request)
        {
            ...
            try
            {
                ...
                Logging.Log.Info("Insert into DB");
                var objDbCaf = CreateCAFModel(request.FolioStartNumber, request.FolioEndNumber, request.RecAgent, request.CAFContent, objCAF, request.Id);
        ...
        private systblApp_CoreAPI_Caf CreateCAFModel(int? foliostartnumber, int? folioendnumber, int? recAgent, string xml, AUTORIZACION objCAF, int id = 0)
        {
