...
namespace CES.CoreApi.Receipt_Main.UI.WPF.Helpers
{
    public class DocumentHelper
    {
        ...
        public DocumentHelper(IDocumentService documentService, ITaxEntityService taxEntityService, ITaxAddressService taxAddressService, ISequenceService sequenceService, IStoreService storeService)
        {
