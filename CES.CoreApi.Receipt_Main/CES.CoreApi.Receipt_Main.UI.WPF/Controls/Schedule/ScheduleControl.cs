...
namespace CES.CoreApi.Receipt_Main.UI.WPF.Controls.Schedule
{
    public class ScheduleControl : Control
    {
        ...
        public static readonly DependencyProperty CurrentDateProperty = DependencyProperty.Register("CurrentDate", typeof(DateTime), typeof(ScheduleControl));
        ...
        static ScheduleControl()
        {
            DefaultStyleKeyProperty.OverrideMetadata(typeof(ScheduleControl), new FrameworkPropertyMetadata(typeof(ScheduleControl)));
        }
        ...
        public ScheduleControl()
        {
            ...
            DayNames = new ObservableCollection<string> { "Lunes", "Martes", "Miercoles", "Jueves", "Viernes", "Sabado", "Domingo"};
        ...
        public void AddEmployee( Day day, string name)
        {
            day.Notes = name;
            Console.WriteLine("adding " + name);
            DayChanged(this, new DayChangedEventArgs(day));
        }
        ...
        private static int DayOfWeekNumber(DayOfWeek dow)
        {
            var day = (int)dow;
            if (day == 0) day = 7;
            return int.Parse( day.ToString("D"));
        }
    }
