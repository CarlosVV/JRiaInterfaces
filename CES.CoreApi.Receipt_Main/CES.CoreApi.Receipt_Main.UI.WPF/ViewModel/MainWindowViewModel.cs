    ...
    public class MainWindowViewModel
    {
        public MainWindowViewModel(IDocumentService documentService, ITaxEntityService taxEntityService, ITaxAddressService taxAddressService, ISequenceService sequenceService, IStoreService storeService, IDialogService dialogService)
        {
            MenuElements = new[]
            {
                ...
                new MenuElement {Label = "Cargar Caf", Content = new CafManagement(storeService, dialogService), MenuStyleType = "Header2"},
                new MenuElement {Label = "Buscar Caf", Content = new CafManagement(storeService, dialogService), MenuStyleType = "Item2" },
