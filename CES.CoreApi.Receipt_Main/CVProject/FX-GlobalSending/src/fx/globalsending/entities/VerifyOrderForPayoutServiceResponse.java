 ...
 * @author cvalderrama
 */
public class VerifyOrderForPayoutServiceResponse {
    ...
    public VerifyOrderForPayoutServiceResponse() {
        this.transrefid = "";
        this.orderfound = "";
        this.pin = "";
        this.orderno = "";
    ...
    public String toString() {
        return this.getTransRefID() + "|"
                ...
                + this.getOrderDate() + "|"
                + this.getCountryFrom() + "|"
                + this.getCustNameFirst() + "|"
                + this.getCustNameLast1() + "|"
                + this.getCustAddress() + "|"
                + this.getCustCity() + "|"
                + this.getCustState() + "|"
                + this.getCustCountry() + "|"
                + this.getCustTelNo() + "|"
                + this.getBeneNameFirst() + "|"
                + this.getBeneNameMiddle() + "|"
                + this.getBeneNameLast1() + "|"
                + this.getBeneAddress() + "|"
                + this.getBeneCity() + "|"
                + this.getBeneState() + "|"
                + this.getBeneCountry() + "|"
                + this.getBeneZip() + "|"
                + this.getBeneTelNo() + "|"
                + this.getBeneCurrency() + "|"
                + this.getBeneAmount() + "|"
                + this.getTransferReason() + "|"
                + this.getResponseDateTimeUTC() + "|"
