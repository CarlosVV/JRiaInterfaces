	...
	public class DataSetting
	{
		public static string GetCode(string countryName)
		{
			try
			{
				...
				var collection = CountryList();
				foreach (var item in collection)
				{
					if (item.Value.Equals(countryName, System.StringComparison.OrdinalIgnoreCase))
						return item.Key;
				}
