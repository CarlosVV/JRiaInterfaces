...
public class GetOrdersValidatedRequestEntity extends BaseRequestEntity {
    ...
    public String getCustID1ExpDate() {
        return custID1ExpDate;
    }

    public void setCustID1ExpDate(String custID1ExpDate) {
        this.custID1ExpDate = custID1ExpDate;
    }
    ...
    public String getCustID2ExpDate() {
        return custID2ExpDate;
    }

    public void setCustID2ExpDate(String custID2ExpDate) {
        this.custID2ExpDate = custID2ExpDate;
    }
    ...
    public String getCustSourceFunds() {
        return custSourceFunds;
    }
