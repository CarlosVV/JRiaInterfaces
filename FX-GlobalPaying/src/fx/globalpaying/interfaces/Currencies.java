...
public class Currencies {
    ...
    public static GetCurrenciesRequestEntity parseInputArgsToRequest(String[] args) {
        GetCurrenciesRequestEntity request = new GetCurrenciesRequestEntity();
    ...
    private static void createSoapEnvelope(SOAPMessage soapMessage,
            GetCurrenciesRequestEntity request) throws SOAPException {
        ...
        // <ces:GetCurrencies>
        SOAPElement getCurrenciesElem = soapBody.addChildElement("GetCurrencies", cesNamespace);
    ...
    private static void parseAndReturnResponse(SOAPMessage soapResponse) {
        try {
                            ...
                            if ("RequestResponses".equals(element4.getElementName().getLocalName())) {
                                ...
                                while (it5.hasNext()) {
                                    ...
                                    while (it6.hasNext()) {
                                        ...
                                        String s2 = element7.getAttribute("Code");
                                        String s3 = element7.getAttribute("CountryName");
                                        currencies.add(s2 + "|" + s3 + "|");
            ...
            if (WarningMsg.length() == 0 && ErrorMsg.length() == 0 && !currencies.isEmpty()) {
    ...
    private static SOAPMessage createSOAPRequest(String soapAction,
            GetCurrenciesRequestEntity request) throws Exception {
