...
public class Commissions {
    ...
    public static GetCommissionsRequestEntity parseInputArgsToRequest(String[] args) {
        GetCommissionsRequestEntity request = new GetCommissionsRequestEntity();
    ...
    private static void createSoapEnvelope(SOAPMessage soapMessage,
            GetCommissionsRequestEntity request) throws SOAPException {
        ...
        // <ces:GetCurrencies>
        SOAPElement getCurrenciesElem = soapBody.addChildElement("GetCommissions", cesNamespace);
                                ...
                                while (it5.hasNext()) {
                                    ...
                                    while (it6.hasNext()) {
                                        ...
                                        while (it7.hasNext()) {
                                            ...
                                            commission = commission + element8.getTextContent() + "|";
                                        }
    ...
    private static SOAPMessage createSOAPRequest(String soapAction,
            GetCommissionsRequestEntity request) throws Exception {
