using CES.CoreApi.WebApi.App_Start;
using CES.CoreApi.WebApi.ExceptionHandling;
using CES.CoreApi.WebApi.Filters;
using CES.Security.CoreApi;
using FluentValidation.WebApi;
using System.Web.Http;
using System.Web.Http.ExceptionHandling;

namespace CES.CoreApi.WebApi
{
	public class WebApiApplication : System.Web.HttpApplication
	{
		protected void Application_Start()
		{
			...
			GlobalConfiguration.Configuration.Filters.Add(new AuthenticationFilter("CES.CoreApi.WebApi"));
