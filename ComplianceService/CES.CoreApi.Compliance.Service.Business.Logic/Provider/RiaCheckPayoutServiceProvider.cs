...
{
    public class RiaCheckPayoutServiceProvider :BaseCheckProvider , ICheckPayoutProvider
    {
        #region Core

        private readonly ICheckPayoutProvider _checkPayoutProvider;
       
        public RiaCheckPayoutServiceProvider(ICheckPayoutProvider checkPayoutProvider)
