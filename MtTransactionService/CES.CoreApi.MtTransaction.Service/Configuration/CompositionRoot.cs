...
using CES.CoreApi.MtTransaction.Service.Business.Logic.Processors;
using CES.CoreApi.MtTransaction.Service.Contract.Models;
using CES.CoreApi.MtTransaction.Service.Data.Materializers;
using CES.CoreApi.MtTransaction.Service.Data.Repositories;
using CES.CoreApi.MtTransaction.Service.Interfaces;
using CES.CoreApi.MtTransaction.Service.Utilities;
...
namespace CES.CoreApi.MtTransaction.Service.Configuration
{
    internal class CompositionRoot
    {
        ...
        private static void RegisterDataAccess(Container container)
        {
            ...
            container.RegisterSingle<ITransactionDetailsMaterializer, TransactionDetailsMaterializer>();
        }
        ...
        {
            container.Register<MtTransactionGetResponse, MtTransactionGetResponse>();
            container.Register<MtTransactionCreateResponse, MtTransactionCreateResponse>();
            container.Register<ClearCacheResponse, ClearCacheResponse>();
            container.Register<DatabasePingResponse, DatabasePingResponse>();
        }
    }
}
