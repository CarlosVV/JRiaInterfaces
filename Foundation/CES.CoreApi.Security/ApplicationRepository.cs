...
{
	public class ApplicationRepository : BaseGenericRepository
	{
		...
		public static Application GetApplicationById(int applicationId)
		{
			...
			return applicationRepository.GetApplicationInfo(applicationId);
		}
		...
		public async Task<ICollection<ApplicationConfiguration>> GetApplicationConfiguration(int applicationId)
		{
			...
			if (application == null)
				throw new Exception("Common.Enumerations.TechnicalSubSystem.CoreApiData, Common.Enumerations.SubSystemError.ApplicationNotFoundInDatabase, applicationId");
