...
using CES.CoreApi.OrderProcess.Service.Business.Logic.Processors;
using CES.CoreApi.OrderProcess.Service.Contract.Models;
using CES.CoreApi.OrderProcess.Service.Data.Repositories;
using CES.CoreApi.OrderProcess.Service.Interfaces;
using CES.CoreApi.OrderProcess.Service.Utilities;
...
namespace CES.CoreApi.OrderProcess.Service.Configuration
{
    internal class CompositionRoot
    {
        ...
        {
            container.Register<OrderGetResponse, OrderGetResponse>();
            container.Register<OrderCreateResponse, OrderCreateResponse>();
        }
    }
}
